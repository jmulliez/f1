export const drivers = [
  ...
  },
  {
    ...
    bio: 'Affectionately known as "Checo", Sergio Perez is a veteran of the sport known as the ultimate "tyre whisperer". He will lead the new Cadillac team in 2026.',
  ...
  },
  {
    ...
    bio: 'Fernando Alonso is a two-time World Champion and considered one of the greatest drivers in F1 history.',
  ...
  },
  {
    ...
    bio: 'Andrea Kimi Antonelli is an Italian racing driver who rose rapidly through the junior single-seater ranks as a Mercedes junior.',
  ...
  },
  {
    ...
    bio: 'Stroll has proven he can deliver podium-worthy performances on his day, racing alongside Alonso at Aston Martin.',
  ...
  },
  {
    ...
    bio: 'A highly experienced driver and multiple race winner with Mercedes. Bottas brings serious pedigree to the new Cadillac project.',
  ...
  },
  {
    ...
    bio: 'China’s first-ever Formula 1 driver. Zhou showed solid consistency during his years at Sauber.',
    currentTeamId: 'sauber', wins: 0, podiums: 0, poles: 0, points: 12, championships: 0,
    image: 'https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/G/GUAZHO01_Guanyu_Zhou/guazho01.png'
  },
  {
    id: 'magnussen', name: 'Kevin', surname: 'Magnussen', nationality: 'Danish', birthDate: '1992-10-05', number: 20,
    bio: 'Aggressive and uncompromising, K-Mag has had a rollercoaster career, deeply intertwined with the Haas F1 team.',
  ...
  },
  {
    ...
    bio: 'A highly respected midfield maestro. Hulkenberg secured the crucial Audi factory drive for their F1 entry.',
  ...
  },
  {
    ...
    bio: 'Tsunoda has matured immensely since his fiery debut, earning a promotion to Red Bull Racing in 2025 before a reserve role in 2026.',
  ...
  },
  {
    ...
    bio: 'The honey badger is one of F1’s most beloved figures and a proven race winner.',
  ...
  },
  {
    ...
    bio: 'Albon rebuilt his career spectacularly at Williams, becoming their absolute team leader.',
  ...
  },
  {
    ...
    bio: 'An American driver who raced for Williams during their rebuilding phase.',
  ...
  },
  {
    ...
    bio: 'Argentine sensation who impressed the paddock immensely as a rookie, securing a seat at Alpine for 2026.',
  ...
  },
  {
    ...
    bio: 'Reigning F2 champion who brings Brazil back to the F1 grid with the new Audi/Sauber project.',
  ...
  },
  {
    ...
    bio: 'Ferrari academy star who earned a full-time seat at Haas following spectacular substitute appearances.',
  ...
  },
  {
    ...
    bio: 'Alpine Academy product who made the step up to a full-time seat for 2025.',
  ...
  },
  {
    ...
    bio: 'No-nonsense Kiwi who proved he belongs in F1 with strong substitute performances, now leading the Visa Cash App RB charge.',
  ...
  },
  {
    ...
    bio: 'A prodigy of the Red Bull junior team, making his debut as the youngest driver on the 2026 grid.',
    currentTeamId: 'rb', wins: 0, podiums: 0, poles: 0, points: 0, championships: 0,
    image: 'https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/A/ARVLIN01_Arvid_Lindblad/arvlin01.png'
  }
];
